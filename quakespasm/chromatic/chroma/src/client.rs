...
use crate::protocol::UserCmdT;
use crate::q_sound::SfxT;
use crate::render::{EFragT, EntityT};
use crate::vid::VID_GRADES;
use crate::{
    Byte, QBoolean, SizeBufT, Vec3T, MAX_CL_STATS, MAX_MODELS, MAX_SCOREBOARDNAME, MAX_SOUNDS,
    MAX_STYLESTRING,
};
use libc::FILE;
